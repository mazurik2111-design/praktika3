...
let maxNumber = Math.max.apply(null, numbers); // для Safari spread може не працювати
...
for (let user of users) {
    if (user.age > 18) adultUsers.push(user);
}
...
let obj = {};
for (let person of people) obj[person] = person.length;
